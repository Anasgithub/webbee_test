...
class EventsController extends BaseController
{
    ...
    public function getEventsWithWorkshops()
    {
        ...
        $getAllEvent = Event::get();

        $resultData = array();
        $i = 0;
        foreach ($getAllEvent as $event) {
            $resultData[$i]['id'] = $event->id;
            $resultData[$i]['name'] = $event->name;
            $resultData[$i]['created_at'] = $event->created_at;
            $resultData[$i]['updated_at'] = $event->updated_at;
            $resultData[$i]['workshops'] = $event->eventWorkshop;
            $i++;
        }
